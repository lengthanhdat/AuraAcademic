    ...
    <div className="p-6 space-y-6 bg-[#0f172a] min-h-screen">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-500 text-sm mt-1">Dữ liệu thống kê từ hệ thống — cập nhật theo thời gian thực</p>
        </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {[
          ...
          <div key={k.label} className="bg-[#1e293b] border border-slate-700/50 rounded-2xl p-5">
            <span className="material-symbols-outlined text-slate-500 text-xl block mb-3" style={{fontVariationSettings:"'FILL' 1"}}>{k.icon}</span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-[#1e293b] border border-slate-700/50 rounded-2xl p-6">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-sm font-bold text-white">Lượt đăng nhập 7 ngày</h3>
            <span className="text-xs text-slate-500">Dữ liệu mẫu</span>
          </div>
        ...
        <div className="bg-[#1e293b] border border-slate-700/50 rounded-2xl p-6">
          <h3 className="text-sm font-bold text-white mb-5">Phân bổ người dùng</h3>
          ...
          <div className="mt-6 pt-4 border-t border-slate-700/50 space-y-2">
            <div className="flex justify-between text-xs">
              <span className="text-slate-400">Đã xác thực email</span>
            ...
            <div className="flex justify-between text-xs">
              <span className="text-slate-400">Bài thi đang hoạt động</span>
      ...
      {/* Alerts section */}
      <div className="bg-[#1e293b] border border-slate-700/50 rounded-2xl p-6">
        <h3 className="text-sm font-bold text-white mb-4">Cảnh báo hệ thống</h3>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
          ...
          {(stats.lockedUsers ?? 0) === 0 && (stats.totalUsers ?? 0) === 0 && (
            <div className="flex items-center gap-3 p-3 bg-slate-700/50 border border-slate-700 rounded-xl col-span-3">
              <span className="material-symbols-outlined text-slate-500">info</span>
              <span className="text-sm text-slate-500">Đang tải dữ liệu cảnh báo...</span>
            </div>
          )}
        </div>
      </div>
