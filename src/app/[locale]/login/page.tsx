    ...
    <div className="flex flex-col min-h-screen bg-surface">
      <header className="fixed top-0 left-0 right-0 z-50 px-8 py-6 flex justify-between items-center bg-transparent pointer-events-none">
        <div className="pointer-events-auto">
          <span className="text-xl font-extrabold text-primary tracking-tight">{t('brand')}</span>
        </div>
          ...
          <div className="relative z-10 max-w-lg space-y-12">
            <div className="space-y-6">
              <div className="inline-flex items-center gap-3 bg-white/10 backdrop-blur-md px-4 py-2 rounded-full border border-white/10">
                ...
                <span className="text-primary-fixed-dim text-sm font-semibold tracking-wider uppercase">{t('hero_badge')}</span>
              </div>
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="bg-white/5 backdrop-blur-sm p-6 rounded-xl border border-white/5">
                ...
                <h3 className="text-white font-bold text-lg">{t('feature_ai_title')}</h3>
                <p className="text-primary-fixed-dim/70 text-sm mt-2">{t('feature_ai_desc')}</p>
              </div>
              <div className="bg-white/5 backdrop-blur-sm p-6 rounded-xl border border-white/5">
                <span className="material-symbols-outlined text-white mb-4 text-3xl">shield</span>
                <h3 className="text-white font-bold text-lg">{t('feature_sec_title')}</h3>
                <p className="text-primary-fixed-dim/70 text-sm mt-2">{t('feature_sec_desc')}</p>
              </div>
            </div>
          </div>
        ...
        <section className="w-full md:w-1/2 flex items-center justify-center p-6 md:p-12 bg-surface relative z-10">
          <div className="w-full max-w-[440px] space-y-8">
            <div className="text-center md:text-left space-y-2">
              <h2 className="text-3xl font-extrabold text-on-surface tracking-tight">{t('welcome')}</h2>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-4 py-2">
                ...
                <span className="text-xs font-bold text-on-surface-variant/60 tracking-widest uppercase">{t('or')}</span>
                <div className="flex-grow h-[1px] bg-outline-variant/20"></div>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  <label className="text-sm font-bold text-on-surface-variant ml-1">{t('email_label')}</label>
                ...
                <div className="space-y-2">
                  <div className="flex justify-between items-center">
                    <label className="text-sm font-bold text-on-surface-variant ml-1">{t('password_label')}</label>
                    <Link className="text-xs font-bold text-primary hover:underline transition-all" href="/forgot-password">{t('forgot_password')}</Link>
                  </div>
                  <div className="relative group">
            ...
            <div className="text-center">
              <p className="text-on-surface-variant text-sm font-medium">
                {t('no_account')} <Link className="text-primary font-bold hover:underline" href="/register">{t('register')}</Link>
              </p>
            </div>
          </div>
        </section>
