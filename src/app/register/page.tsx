    ...
    <div className="bg-surface font-body text-on-surface antialiased min-h-screen">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 flex justify-between items-center w-full px-6 py-4 mx-auto bg-[#f7f9fb] dark:bg-slate-950">
        ...
        <div className="flex items-center gap-4">
          ...
          <button className="material-symbols-outlined text-[#42474f] hover:bg-slate-200/50 p-2 rounded-full transition-colors">language</button>
        </div>
      </header>
          ...
          <div className="relative z-10 w-full max-w-2xl space-y-8">
            <div className="space-y-4">
              <h1 className="font-headline text-5xl font-extrabold text-primary tracking-tight leading-tight">
                Kiến tạo tương lai <br/> qua tri thức số.
              </h1>
              <p className="text-on-surface-variant text-lg max-w-md leading-relaxed">
                Hệ thống thi trực tuyến thông minh, bảo mật và công bằng nhất dành cho các tổ chức giáo dục hiện đại.
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-6 pt-8">
              <div className="bg-surface-container-lowest p-6 rounded-xl shadow-sm border border-outline-variant/10">
                ...
                <h3 className="font-headline font-bold text-on-surface">Bảo mật AI</h3>
                <p className="text-sm text-on-surface-variant mt-2">Giám sát tự động bằng trí tuệ nhân tạo tiên tiến.</p>
              </div>
              <div className="bg-surface-container-lowest p-6 rounded-xl shadow-sm border border-outline-variant/10 translate-y-8">
                ...
                <h3 className="font-headline font-bold text-on-surface">Phân tích sâu</h3>
                <p className="text-sm text-on-surface-variant mt-2">Báo cáo kết quả chi tiết cho từng cá nhân và lớp học.</p>
              </div>
            </div>
          </div>
        ...
        <section className="w-full md:w-1/2 lg:w-2/5 flex items-center justify-center p-6 md:p-12 lg:p-16 bg-surface">
          <div className="w-full max-w-md space-y-8">
            <div className="space-y-2">
              <h2 className="font-headline text-3xl font-extrabold text-on-surface">Tạo tài khoản mới</h2>
              <p className="text-on-surface-variant text-sm">Chào mừng bạn đến với hệ thống thi Digital Proctor</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-1.5">
                <label className="text-xs font-bold text-on-surface-variant uppercase tracking-wider px-1" htmlFor="full_name">Họ và tên</label>
                <input 
                  id="full_name"
              ...
              <div className="space-y-1.5">
                <label className="text-xs font-bold text-on-surface-variant uppercase tracking-wider px-1" htmlFor="email">Email</label>
                <input 
                  id="email"
              ...
              <div className="space-y-1.5 relative">
                <label className="text-xs font-bold text-on-surface-variant uppercase tracking-wider px-1" htmlFor="password">Mật khẩu</label>
                <input 
                  id="password"
            ...
            <p className="text-center text-sm text-on-surface-variant">
              Đã có tài khoản? <Link className="text-primary font-bold hover:underline" href="/login">Đăng nhập ngay</Link>
            </p>
          </div>
        </section>
      </main>
